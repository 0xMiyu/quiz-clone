    ...
    return (
        <div className="my-10">
            ...
            <h2 className="text-4xl md:text-5xl text-white font-bold my-2">
                This week&apos;s{" "}
                <span className="font-light text-gradient">grand prize!</span>
            </h2>
            ...
            <div className="my-6 flex space-x-3 md:space-x-6">
                ...
                <div className="border-4 border-white rounded-xl md:rounded-3xl flex flex-col justify-center items-center w-[100%]">
                    <p className="text-4xl md:text-7xl font-bold">4,500</p>
                </div>
            </div>

            <h2 className="text-4xl md:text-5xl text-white font-bold my-2">
                Solana value{" "}
                <span className="font-light text-gradient">in the pot!</span>
            </h2>
            ...
            <div className="my-6 flex space-x-3 md:space-x-6">
                ...
                <div className="border-4 border-white rounded-xl md:rounded-3xl flex flex-col justify-center items-center w-[100%]">
                    <p className="text-4xl md:text-7xl font-bold">4,425,500</p>
                </div>
            </div>
        </div>
    );
